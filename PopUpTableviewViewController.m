...
-(void)ConnectToFaceBook {
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   @"I’ve just started using a new iGCSE Chemistry videos App! Hundreds of quality Chemistry videos. You should check it out, or search LearnersCloud in your device’s App store.",  @"message",
                                   nil];
...
-(void)Twit {
    ...
    if ([TWTweetComposeViewController canSendTweet])
    {
        ...
        [tweetSheet setInitialText:@"Checkout @LearnersCloud #iGCSE Chemistry video app. Learn and revise Chemistry on the go."];
